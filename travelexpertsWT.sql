...
--
CREATE DATABASE IF NOT EXISTS `travelexpertsWT` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `travelexpertsWT`;
...
(1, 'Janet', NULL, 'Delton', '(403) 210-7801', 'janet.delton@travelexpertsWT.com', 'Senior Agent', 1),
(2, 'Judy', NULL, 'Lisle', '(403) 210-7802', 'judy.lisle@travelexpertsWT.com', 'Intermediate Agent', 1),
(3, 'Dennis', 'C.', 'Reynolds', '(403) 210-7843', 'dennis.reynolds@travelexpertsWT.com', 'Junior Agent', 1),
(4, 'John', NULL, 'Coville', '(403) 210-7823', 'john.coville@travelexpertsWT.com', 'Intermediate Agent', 1),
(5, 'Fred', 'J', 'Smith', '(403) 210-5555', 'fred@travelexpertsWT.com', 'Junior Agent', 2),
(6, 'Bruce', 'J.', 'Dixon', '(403) 210-7867', 'bruce.dixon@travelexpertsWT.com', 'Intermediate Agent', 2),
(7, 'Beverly', 'S.', 'Jones', '(403) 210-7812', 'beverly.jones@travelexpertsWT.com', 'Intermediate Agent', 1),
(8, 'Jane', NULL, 'Merrill', '(403) 210-7868', 'jane.merrill@travelexpertsWT.com', 'Senior Agent', 2),
(9, 'Brian', 'S.', 'Peterson', '(403) 210-7833', 'brian.peterson@travelexpertsWT.com', 'Junior Agent', 2);
